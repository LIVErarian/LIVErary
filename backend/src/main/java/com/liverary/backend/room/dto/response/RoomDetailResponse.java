...
public class RoomDetailResponse {
    ...
    @Builder
    public RoomDetailResponse(UUID roomId, String title, RoomType roomType, AccessType accessType, RoomStatus status, String categoryName, Integer currentCount, Integer maxUser, String bookTitle, String bookAuthor, String bookCoverUrl) {
        this.roomId = roomId;
        this.title = title;
