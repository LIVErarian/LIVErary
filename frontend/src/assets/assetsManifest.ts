  ...
  bundles: [
    ...
    },
    {
      ...
      assets: [
        ...
        { alias: 'calm_3', src: '/assets/bgm/calm_3' },
        { alias: 'calm_4', src: '/assets/bgm/calm_4' },
        { alias: 'calm_5', src: '/assets/bgm/calm_5' },
        { alias: 'fairy_1', src: '/assets/bgm/fairy_1' },
        { alias: 'fairy_2', src: '/assets/bgm/fairy_2' },
        { alias: 'fairy_3', src: '/assets/bgm/fairy_3' },
        { alias: 'fairy_4', src: '/assets/bgm/fairy_4' },
        { alias: 'fairy_5', src: '/assets/bgm/fairy_5' },
        { alias: 'fairy_6', src: '/assets/bgm/fairy_6' },
        { alias: 'alternative_1', src: '/assets/bgm/alternative_1' },
        { alias: 'sf_1', src: '/assets/bgm/sf_1' },
      ],
    },
  ],
};
